        ...
        if self.df is not None:
            ...
            if self.selected_columns and self.search_values:
                try:
                    ...
                    messagebox.showerror("Error", f"Column '{e}' does not exist in the DataFrame.")
                except Exception as e:
                    messagebox.showerror("Error", f"Error during search: {e}")
            else:
                messagebox.showwarning("Warning", "Please select at least one column and enter values to search.")
        else:
            messagebox.showwarning("Warning", "Please upload and clean an Excel file first.")
