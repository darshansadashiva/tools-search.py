...
class ExcelApp:
    ...
    def create_widgets(self):
        ...
        title_label = tk.Label(self.left_frame, text="KENNAMETAL INC. WorkTools Search", font=("Helvetica", 18, "bold"), fg="#333333")
        ...
        self.value_entry_frame.pack(pady=30, fill=tk.BOTH, expand=True)
